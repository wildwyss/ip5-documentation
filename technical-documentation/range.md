...
Ranges can process sequences of almost any size and require hardly any memory or computing power. They are therefore very well suited as building blocks for larger constructs. Because ranges process sequences of numbers they can be used very versatile. Possible use cases are for example the lazy generation of numbers or to execute a certain action `n` times.
